        ...
        VStack {
            ...
            if self.card.expand {
                VStack{
                    ...
                    Text("A harmonious blend of fresh ingredients and bold flavors, this dish combines vibrant textures and tastes to create a delightful and satisfying experience. It’s both comforting and exciting, offering a well-balanced bite in every mouthful.")
                        .padding(.all, /*@START_MENU_TOKEN@*/10/*@END_MENU_TOKEN@*/)
                }
            }
        }
